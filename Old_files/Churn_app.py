...
def online_input():
    ...
    feedback = st.sidebar.selectbox("Last Feedback", ['Support Response Delays', 'Frequent Software Downtime',
    ...
    preferred_offer_types = st.sidebar.selectbox("Preferred Offer Types", ['Gift Vouchers/Coupons',
                                                                           'Credit/Debit Card Offers',
                                                                           'Without Offers'])
    technology_primary = st.sidebar.selectbox("Technology Primary", ['Analytics', 'ERP Implementation',
